...
export default function ThemeBar({ onOpen }) {
  return (
    <button
      type="button"
      onClick={onOpen}
      className={`mx-auto flex w-[90%] items-center justify-center gap-1 rounded-full border border-white/50 ${GLASS_BG} py-3 text-xs backdrop-blur-md shadow-[inset_0_2px_4px_rgba(0,0,0,0.1),inset_0_-6px_10px_rgba(180,120,70,0.25)] transition-colors hover:bg-[rgba(255,255,255,0.35)] ${UI_TEXT_STYLE}`}
    >
