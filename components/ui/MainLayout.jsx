...
// HangerIcon/CupIcon/CatIcon: glifos reemplazados por la hoja de
// referencia de íconos del usuario (Store/Pets) — Percha, Vaso y
// "cara" de mascota. El ícono de moneda (TokenIcon, con el
// monograma "Z" de la marca) se deja tal cual a pedido explícito, no
// se reemplaza por el monograma "N" de esa misma hoja.
function HangerIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 3.2c-2 2.3-2 15.3 0 17.6L16.2 12Z" />
      <path d="M16.2 12h2a1.7 1.7 0 1 0 1.5-2.6" />
    </svg>
  );
}
function CupIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      <path d="M3.5 8.3 12 4v16l-8.5-4.3Z" fill="currentColor" />
      <circle cx="12" cy="12" r="6" fill="none" stroke="currentColor" strokeWidth="1.8" />
      <path d="m16.7 16.7 2.6 2.6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" fill="none" />
    </svg>
  );
}
function CatIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      <path
        fill="currentColor"
        d="M8 3h7.3a1 1 0 0 1 .8 1.6L14 8l2.1 3.4a1 1 0 0 1 0 1.2L14 16l2.1 3.4a1 1 0 0 1-.8 1.6H8a4 4 0 0 1-4-4V7a4 4 0 0 1 4-4Z"
      />
      <circle cx="9.6" cy="8.3" r="1.05" fill={GLASS_ACCENT_COLOR} />
      <rect x="8.85" y="11" width="1.5" height="2.6" rx="0.75" fill={GLASS_ACCENT_COLOR} />
      <circle cx="9.6" cy="15.7" r="1.05" fill={GLASS_ACCENT_COLOR} />
    </svg>
  );
}
