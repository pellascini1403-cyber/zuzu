...
// TokenIcon: la referencia más reciente muestra el mismo isotipo
// ya usado (aro + disco + trazo "Z" — el texto que acompañaba a esa
// imagen decía "N", pero el glifo trazado es una "Z", igual que la
// marca Zuzu del resto de la app, así que se mantiene consistente
// con eso) con un ANILLO DOBLE en vez de uno solo: se agrega un
// segundo círculo concéntrico entre el aro exterior y el disco
// relleno.
function TokenIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="1.3" />
      <circle cx="12" cy="12" r="8.1" fill="none" stroke="currentColor" strokeWidth="1.1" />
      <circle cx="12" cy="12" r="6.6" fill="currentColor" />
